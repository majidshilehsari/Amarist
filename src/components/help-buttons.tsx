...
export const HELP_CONTENTS: Record<string, HelpContent> = {
  ...
  draw: {
    help: [
      ...
      "چیدمان خودکار، پیش‌بین‌ها را در چپ، پیامدها را در راست و میانجی را بالای محور مستقیم می‌گذارد؛ با دو میانجی، یکی بالا و دیگری پایین قرار می‌گیرد.",
      "زیرمقیاس‌های سازهٔ سمت چپ در سمت چپ آن و شاخص‌های پیامد در سمت راست قرار می‌گیرند تا مسیر مستقیم وسط شکل باز بماند.",
      "با «ویرایش دستی چیدمان» می‌توانید گره‌ها و زیرمقیاس‌ها را با ماوس/لمس بکشید؛ کلیدهای جهت نیز جابه‌جایی دقیق انجام می‌دهند.",
  ...
  diagram: {
    help: [
      ...
      "مسیر مستقیم پیش‌بین به پیامد روی محور میانی صاف است؛ میانجی‌ها بالا/پایین این محور قرار می‌گیرند تا اثر مستقیم و غیرمستقیم فوراً قابل تشخیص باشد.",
      "در حالت ویرایش، هر گره یا شاخص را بکشید و در پایان «پایان ویرایش چیدمان» را بزنید؛ چیدمان در همان پروژه ذخیره می‌شود.",
      "رنگ‌ها: آبی = برون‌زا، نارنجی = میانجی، سبز = درون‌زا.",
    ],
    guide: {
      title: "درسنامه: رسم و تفسیر دیاگرام مسیر",
      paragraphs: [
        "برای خوانش سریع مدل میانجی، آماریست جهت اثر را از چپ به راست نگه می‌دارد: پیش‌بین در چپ، پیامد در راست و میانجی در میانه اما بیرون از محور مستقیم قرار می‌گیرد. در مدل دو میانجی، یکی بالا و دیگری پایین محور می‌آید.",
        "مسیر مستقیم X→Y صاف باقی می‌ماند و مسیرهای X→M→Y مثلث میانجی‌گری را می‌سازند؛ این تفکیک، اثر مستقیم و غیرمستقیم را بدون دنبال‌کردن قوس‌های بلند نشان می‌دهد.",
  ...
  inferential: {
    help: [
      ...
      "گزارش نهایی فقط نتایج تحلیلی قابل‌تفسیر را نشان می‌دهد و جزئیات داخلی تولید داده در آن نمایش داده نمی‌شود.",
    ],
    guide: {
  ...
  report: {
    help: [
      ...
      "از «راهبری سریع گزارش» روی نام هر بخش، مثلاً «۱۰. شاخص‌های برازش مدل»، بزنید تا همان قسمت فوراً در دید قرار گیرد.",
