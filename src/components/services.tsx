...
const services = [
  {
    ...
    description:
      "داده‌های پژوهشی خود را وارد کنید؛ آماریست تحلیل توصیفی و استنباطی را انجام می‌دهد و گزارش آماری قابل‌ارائه تحویل می‌دهد.",
    features: [
    ...
    <section id="services" className="scroll-mt-20 py-20 lg:py-24">
      <div className="mx-auto max-w-6xl px-4 sm:px-6">
        <SectionHeading
          ...
          description="اساتید در حین درس‌دادن، سخت‌ترین بخش را پیدا کردن داده‌های تمرینی می‌دانند که دانشجوها با آن‌ها به نتایجِ مشابه برسند. آماریست این دو سرویس را کنار هم می‌گذارد."
        />
